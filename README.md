...
> A Spring AI 2.0 playground: ChatClient, sliding-window chat memory and advisors — plus strict quality gates (Spotless + Alibaba P3C PMD) and a learning-checkpoint documentation workflow.
